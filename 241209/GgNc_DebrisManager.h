...
private:
	...
	UFUNCTION(BlueprintCallable, BlueprintPure = false, meta = (Keywords = "GgDebris"), Category = "GgNc | Particle")
	void DelayTest() const noexcept;

	int64 UnixTime;



	UPROPERTY(EditDefaultsOnly, Category = "GgNc | Manager")
	TObjectPtr<UNiagaraSystem> DebrisBaseEffectTemplate = nullptr;

	UPROPERTY(EditInstanceOnly, Category = "GgNc | Manager")
	TObjectPtr<ANiagaraActor> DebrisBaseFX = nullptr;
};
